        ...
        for result in response.css('table.race_table_01 tr')[1:]:
            ...
            if num_cols == 21:
                race_data['horses'].append({
                    ...
                    'jockey_id': columns[6].xpath(xpath_link_url).re_first(r'/jockey/(?:result/recent/)?(.+)/'),
                    'jockey_name': columns[6].xpath(xpath_link_text).get(),
                    'jockey_weight': columns[5].xpath(xpath_text).get(),
                    'trainer_id': columns[18].xpath(xpath_link_url).re_first(r'/trainer/(?:result/recent/)?(.+)/'),
                    'trainer_name': columns[18].xpath(xpath_link_text).get(),
                    'owner_id': columns[19].xpath(xpath_link_url).re_first(r'/owner/(?:result/recent/)?(.+)/'),
                ...
                race_data['horses'].append({
                    ...
                    'jockey_name': columns[6].xpath(xpath_link_text).get(),
                    'jockey_weight': columns[5].xpath(xpath_text).get(),
                    'trainer_id': columns[11].xpath(xpath_link_url).re_first(r'/trainer/(?:result/recent/)?(.+)/'),
                    'trainer_name': columns[11].xpath(xpath_link_text).get(),
                    'owner_id': columns[12].xpath(xpath_link_url).re_first(r'/owner/(?:result/recent/)?(.+)/'),
